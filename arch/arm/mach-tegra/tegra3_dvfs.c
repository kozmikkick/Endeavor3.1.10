...
int user_mv_table[MAX_DVFS_FREQS] = {
	800, 825, 850, 875, 900, 916, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1212, 1237, 1300};
#endif
...
static struct dvfs cpu_dvfs_table[] = {
	...
	CPU_DVFS("cpu_g",  4, 0, MHZ, 460, 550, 550, 680,  680,  680,  820,  970,  970,  1040, 1080, 1150, 1200, 1240, 1280, 1320, 1360, 1500, 1550, 1600),
	CPU_DVFS("cpu_g",  4, 1, MHZ, 480, 650, 650, 780,  780,  780,  990,  1040, 1040, 1100, 1200, 1250, 1300, 1330, 1400, 1500, 1550, 1600),
	CPU_DVFS("cpu_g",  4, 2, MHZ, 520, 700, 700, 860,  860,  860,  1050, 1150, 1150, 1200, 1280, 1300, 1340, 1500, 1550, 1600),
	CPU_DVFS("cpu_g",  4, 3, MHZ, 550, 770, 770, 910,  910,  910,  1150, 1230, 1230, 1280, 1330, 1400, 1500, 1550, 1600),
...
static struct dvfs core_dvfs_table[] = {
	...
	CORE_DVFS("vde",    0, 1, KHZ,        1, 275000, 332000, 380000, 416000,  520000,  520000,  520000,  520000),
	CORE_DVFS("mpe",    0, 1, KHZ,        1, 285000, 332000, 380000, 416000,  520000,  520000,  520000,  520000),
	CORE_DVFS("2d",     0, 1, KHZ,        1, 285000, 332000, 380000, 416000,  520000,  520000,  520000,  520000),
	CORE_DVFS("epp",    0, 1, KHZ,        1, 285000, 332000, 380000, 416000,  520000,  520000,  520000,  520000),
	CORE_DVFS("3d",     0, 1, KHZ,        1, 285000, 332000, 380000, 416000,  520000,  520000,  520000,  520000),
	CORE_DVFS("3d2",    0, 1, KHZ,        1, 285000, 332000, 380000, 416000,  520000,  520000,  520000,  520000),
	CORE_DVFS("se",     0, 1, KHZ,        1, 285000, 332000, 380000, 416000,  520000,  520000,  520000,  520000),

	CORE_DVFS("vde",    1, 1, KHZ,        1, 275000, 332000, 380000, 416000,  520000,  520000,  520000,  520000),
	CORE_DVFS("mpe",    1, 1, KHZ,        1, 285000, 332000, 380000, 416000,  520000,  520000,  520000,  520000),
	CORE_DVFS("2d",     1, 1, KHZ,        1, 285000, 332000, 380000, 416000,  520000,  520000,  520000,  520000),
	CORE_DVFS("epp",    1, 1, KHZ,        1, 285000, 332000, 380000, 416000,  520000,  520000,  520000,  520000),
	CORE_DVFS("3d",     1, 1, KHZ,        1, 285000, 332000, 380000, 416000,  520000,  520000,  520000,  520000),
	CORE_DVFS("3d2",    1, 1, KHZ,        1, 285000, 332000, 380000, 416000,  520000,  520000,  520000,  520000),
	CORE_DVFS("se",     1, 1, KHZ,        1, 285000, 332000, 380000, 416000,  520000,  520000,  520000,  520000),
	...
	CORE_DVFS("host1x", 2, 1, KHZ,        1, 188000, 222000, 254000, 267000,  267000,  267000,  300000,  300000),
	CORE_DVFS("host1x", 3, 1, KHZ,        1,      1,      1,      1,      1,       1,  242000,  242000,  242000),

	CORE_DVFS("cbus",   0, 1, KHZ,        1, 275000, 332000, 380000, 520000,  520000,  520000,  520000,  520000),
	CORE_DVFS("cbus",   1, 1, KHZ,        1, 275000, 332000, 380000, 520000,  520000,  520000,  520000,  520000),
	...
	CORE_DVFS("pll_c",  -1, 1, KHZ,  667000, 800000, 800000, 1066000, 1066000, 1200000, 1200000, 1200000, 1400000),
