...
int user_mv_table[MAX_DVFS_FREQS] = {
	800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1163, 1175, 1188, 1200, 1263};
#endif
...
static const unsigned int cpu_cold_offs_mhz[MAX_DVFS_FREQS] = {
	  50,  50,  50,  50,  50,  50,  50,  50,  50,   50,   50,   50,   50,   50,   50,   50,   25,   50,   50,   50};
...
/* Cpu voltages (mV):		      800, 825, 850, 875,  900,  925,  950,  975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1163, 1175, 1188, 1200, 1263 */
	CPU_DVFS("cpu_g",  4, 0, MHZ, 475, 640, 760, 860,  910, 1000, 1050, 1100, 1150, 1200, 1300, 1400, 1500, 1550, 1600, 1624, 1700),
	CPU_DVFS("cpu_g",  4, 1, MHZ, 475, 640, 760, 860,  910, 1000, 1050, 1100, 1150, 1200, 1300, 1400, 1500, 1550, 1600, 1624, 1700),
	CPU_DVFS("cpu_g",  4, 2, MHZ, 475, 640, 760, 860,  910, 1000, 1050, 1100, 1150, 1200, 1300, 1400, 1500, 1550, 1600, 1624, 1700),
	CPU_DVFS("cpu_g",  4, 3, MHZ, 475, 640, 760, 860,  910, 1000, 1050, 1100, 1150, 1200, 1300, 1400, 1500, 1550, 1600, 1624, 1700),
